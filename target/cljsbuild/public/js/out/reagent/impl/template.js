...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__21876__auto__,writer__21877__auto__,opt__21878__auto__){
return cljs.core._write.call(null,writer__21877__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21278__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21278__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21278__auto__)){
return or__21278__auto__;
} else {
...
var G__22819 = o;
(G__22819[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__22820__delegate = function (args){
...
while (G__22821__i < G__22821__a.length) {G__22821__a[G__22821__i] = arguments[G__22821__i + 0]; ++G__22821__i;}
  args = new cljs.core.IndexedSeq(G__22821__a,0);
} 
return G__22820__delegate.call(this,args);};
...
return G__22820__delegate(args);
});
...
var old_22823 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_22823))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_22823)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21266__auto__ = (node === document.activeElement);
if(and__21266__auto__){
var and__21266__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21266__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__22826 = jsprops;
(G__22826["defaultValue"] = value);

(G__22826["onChange"] = ((function (G__22826,v,value,on_change){
return (function (p1__22824_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22824_SHARP_);
});})(G__22826,v,value,on_change))
);
...
var vec__22828 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22828,(0),null);
var id = cljs.core.nth.call(null,vec__22828,(1),null);
var class$ = cljs.core.nth.call(null,vec__22828,(2),null);
...
var temp__4659__auto__ = (function (){var G__22832 = cljs.core.meta.call(null,v);
if((G__22832 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22832);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__22834_22835 = v;
var G__22834_22836__$1 = (((G__22834_22835 == null))?null:reagent.impl.template.key_from_vec.call(null,G__22834_22835));
if((G__22834_22836__$1 == null)){
} else {
(jsprops["key"] = G__22834_22836__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__22839 = cljs.core.meta.call(null,argv);
if((G__22839 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22839);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__22840 = (((jsprops == null))?{}:jsprops);
(G__22840["key"] = key);
...
var G__22841 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22841;
continue;
}
} else {
...
var n__22181__auto___22842 = a.length;
var i_22843 = (0);
while(true){
if((i_22843 < n__22181__auto___22842)){
(a[i_22843] = reagent.impl.template.as_element.call(null,(a[i_22843])));
...
var a = cljs.core.into_array.call(null,s);
var n__22181__auto___22845 = a.length;
var i_22846 = (0);
while(true){
if((i_22846 < n__22181__auto___22845)){
var val_22847 = (a[i_22846]);
if((cljs.core.vector_QMARK_.call(null,val_22847)) && ((reagent.impl.template.key_from_vec.call(null,val_22847) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22846] = reagent.impl.template.as_element.call(null,val_22847));
...
if(cljs.core.truth_((function (){var and__21266__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21266__auto__){
return (ctx["no-key"]);
} else {
return and__21266__auto__;
...
var G__22850 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22850) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22850){
