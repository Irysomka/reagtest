...
var or__21278__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21278__auto__)){
return or__21278__auto__;
} else {
var or__21278__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21278__auto____$1)){
return or__21278__auto____$1;
} else {
var or__21278__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21278__auto____$2)){
return or__21278__auto____$2;
} else {
var or__21278__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21278__auto____$3)){
return or__21278__auto____$3;
} else {
...
var n__22181__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22181__auto__)){
var c_22755 = (a[i]);
if(cljs.core.truth_((c_22755["cljsIsDirty"]))){
(c_22755["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__21876__auto__,writer__21877__auto__,opt__21878__auto__){
return cljs.core._write.call(null,writer__21877__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__22759 = c;
var G__22759__$1 = (((G__22759 == null))?null:(G__22759["props"]));
if((G__22759__$1 == null)){
return null;
} else {
return (G__22759__$1["argv"]);
}
});
...
var G__22761_22762 = (c["cljsRatom"]);
if((G__22761_22762 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__22761_22762);
}
